...
<html lang="en">
    <head>
        ...
        <link rel="icon" href="<?php echo base_url(); ?>assets/img/dukcapil-icons.png">
        <title><?php echo $page_title; ?></title>
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.8.1/css/all.min.css">

        <link href="<?php echo base_url(); ?>plugins/flow_builder/css/app.a92522c0.css" rel="preload" as="style">
        <link href="<?php echo base_url(); ?>plugins/flow_builder/css/chunk-vendors.bff25d1a.css" rel="preload" as="style">
        <link href="<?php echo base_url(); ?>plugins/flow_builder/js/app.22342952.js" rel="preload" as="script">
        ...
        <link href="<?php echo base_url(); ?>plugins/flow_builder/css/app.a92522c0.css" rel="stylesheet">
    ...
    <body>
        ...
        <script src="<?php echo base_url(); ?>plugins/flow_builder/js/app.22342952.js"></script>
