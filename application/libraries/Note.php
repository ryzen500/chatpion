...
echo sizeof($response);
	...
	foreach($response as $r){
		...
		$str.='
		<li class="media py-2 my-0 px-4 open_conversation"style="cursor:pointer">
			<img alt="image" class="mr-3 rounded-circle border" width="50" height="50" src="'.$default.'">
			<div class="media-body">
			  <div class="mt-0 mb-1 font-weight-bold text-primary">'.$r[1]['nama'].'<span class="badge badge-danger badge-pill ml-2 px-2 py-1 d-none">2</span></div>
			  <div class="text-small font-600-bold"><i class="fas fa-circle text-success pb-1" style="font-size:8px"></i> '.$r[1]['nama'].'</div>
			</div>
		</li>';
