...
<script>
  ...
  var get_pages_conversation_url = 'get_pages_conversation_yaestar';
  var reply_to_conversation_url = 'reply_to_conversation';
</script>


<?php include(FCPATH.'application/views/message_manager/yaestar_message_dashboard_common_js.php');?>  